...
import studio.mevera.lotus.internal.opener.DefaultViewOpener;
...
public final class Lotus {
    ...
    private final ViewOpener defaultOpener = new DefaultViewOpener();
    ...
    Lotus(@NotNull Plugin plugin, @NotNull Options options) {
    ...
    public @NotNull ViewOpener openerFor(@NotNull InventoryType type) {
        return openers.getOrDefault(type, defaultOpener);
    }
