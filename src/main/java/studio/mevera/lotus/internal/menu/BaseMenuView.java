...
/**
 * Reference {@link MenuView} implementation. Holds the resolved capacity/title/content and the
 * Bukkit {@link Inventory} once opened.
 */
public class BaseMenuView<M extends Menu> implements MenuView<M> {
    ...
    @Override public @NotNull Component title() { return require(title, "title"); }
    ...
    /**
     * Resolves capacity/title/content from the template. Idempotent — safe to call before each open.
     */
