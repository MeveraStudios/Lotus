...
/**
 * Builder for {@link PageLayout}{@code <String>}. Compatible with Spigot 1.8.8 and above.
 ...
 * <p>
 * For Paper 1.21+ with Adventure {@code Component} titles, use {@code PaperPageLayoutBuilder}
 * in the {@code lotus-paper} module instead.
 */
public final class PageLayoutBuilder {
    ...
    private Function<PageContext, String> title = ctx -> "Page " + (ctx.pageIndex() + 1);
    ...
    public @NotNull PageLayoutBuilder title(@NotNull Function<PageContext, String> title) {
    ...
    public @NotNull PageLayout<String> build() {
    ...
    private record BuiltPageLayout(
        ...
        @NotNull Function<PageContext, String> titleFn,
    ...
    ) implements PageLayout<String> {

        @Override public @NotNull String title(@NotNull PageContext ctx) { return titleFn.apply(ctx); }
