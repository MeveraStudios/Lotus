...
mavenPublishing {
    coordinates(group.toString(), "lotus-commons", version.toString())
    pom {
        name.set("Lotus Commons")
        description.set("Shared API and runtime module for the Lotus GUI framework.")
